"""Template entrypoint. Run as: python -m bots.python.template"""
...
from bots.python.core.bot import TradingBot
from bots.python.core.config import BotConfig
from bots.python.template.strategy import TemplateStrategy
